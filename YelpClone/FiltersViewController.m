...
- (void)viewDidLoad {
    ...
    [[UINavigationBar appearance] setBarTintColor:[UIColor colorWithRed:0.6705882352941176 green:0.0 blue:0.0039215686274509803 alpha:1.0]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    SwitchCell *cell = [[SwitchCell alloc] init];
    cell.delegate = self;
    cell.cellLabel.text = self.categories[indexPath.row];
    return cell;
}
